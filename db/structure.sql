...
CREATE TABLE public.estimates (
    id bigint NOT NULL,
    best_case_points integer,
    worst_case_points integer,
    user_id integer,
    story_id integer,
...
--
-- Name: index_stories_on_searchable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_stories_on_searchable ON public.stories USING gin (searchable);
