...
RSpec.describe "managing projects", js: true do
  ...
  context "when the project is unarchived" do
    ...
    it "allows me to delete a project when javascript is not enabled", js: false do
      click_link "Edit or Delete Project"
      click_link "Delete Project"
      expect(Project.count).to eq 0
    end

    context "when the project has subprojects" do
    ...
    context "when importing and exporting" do
      before do
    ...
    context "when picking sub-projects" do
